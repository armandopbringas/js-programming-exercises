...
const pigLatin = (word) => {
  ...
  if (firstLetterIsConsonant && secondLetterIsConsonant === false) return word + 'way';
	if (firstLetterIsConsonant === true && secondLetterIsConsonant === false) return wordWithoutFirstLetter + firstLetter + 'ay';
  if (firstLetterIsConsonant && secondLetterIsConsonant === true) return wordWithoutSecondtLetter + firstLetter + secondLetter + 'ay';
};
